...
public class CustomerControllerTest {
    ...
    private CustomerViewModel inputCustomer;
    private String inputCustomerJsonString;
    private CustomerViewModel outputCustomer;
    private String outputCustomerJsonString;
    private List<CustomerViewModel> customerViewModelList;
    ...
    public void setUp() throws Exception {
        inputCustomer = new CustomerViewModel();
        ...
        outputCustomer = new CustomerViewModel();
